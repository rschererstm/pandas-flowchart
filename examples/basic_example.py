...
def create_sample_data():
    ...
    exams = pd.DataFrame({
        ...
        "status": np.random.choice(["completed", "pending", "cancelled"], n_exams, p=[0.8, 0.15, 0.05]),
    })
...
def main():
    ...
    final = unique_exams.assign(
        age_group=pd.cut(unique_exams["age"], bins=[18, 30, 50, 70, 100], labels=["18-30", "31-50", "51-70", "71+"]),
