...
def text_box(
    ...
    if title:
        ...
        top = BOX_CHARS["top_left"] + BOX_CHARS["horizontal"] * left_border + title_part + BOX_CHARS["horizontal"] * right_border + BOX_CHARS["top_right"]
    else:
    ...
    for line in lines:
        ...
        result.append(BOX_CHARS["vertical"] + " " * padding + padded + " " * padding + BOX_CHARS["vertical"])
    
    # Bottom border
    bottom = BOX_CHARS["bottom_left"] + BOX_CHARS["horizontal"] * inner_width + BOX_CHARS["bottom_right"]
