...
OPERATION_CATEGORIES = {
    "Data Loading": [OperationType.READ_CSV, OperationType.READ_EXCEL, 
                     OperationType.READ_PARQUET, OperationType.READ_JSON, OperationType.READ_SQL],
    ...
    "Reshape": [OperationType.PIVOT, OperationType.PIVOT_TABLE, OperationType.MELT, 
                OperationType.STACK, OperationType.UNSTACK],
...
class TrackedVariableStats:
    ...
    top_values: list[tuple[Any, int, float]] = field(default_factory=list)  # (value, count, percentage)
